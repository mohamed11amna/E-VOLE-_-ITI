<x-admin-layout>
    <header class="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-12">
        <div class="flex flex-col gap-4 max-w-2xl">
            <h1 class="font-display-lg text-display-lg text-primary">Edit User</h1>
        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-8">
            ...
            <div class="space-y-6">
                ...
                <div class="pt-6 border-t border-outline/10">
                    <h3 class="font-title-lg text-primary mb-4">Change Password (Optional)</h3>
                    <p class="text-on-surface-variant text-sm mb-6">Leave these fields blank if you do not wish to change the user's password.</p>
                    
                    <div class="space-y-6">
                        <div>
                            <label for="password" class="block font-label-lg text-label-lg text-primary mb-2">New Password</label>
                        ...
                        <div>
                            <label for="password_confirmation" class="block font-label-lg text-label-lg text-primary mb-2">Confirm New Password</label>
                ...
                @if($user->id !== auth()->id())
                <div class="pt-6 pb-2 border-t border-outline/10">
                    <h3 class="font-title-lg text-primary mb-4">Permissions</h3>
                ...
                <div class="pt-6 pb-2 border-t border-outline/10">
                    <h3 class="font-title-lg text-primary mb-4">Permissions</h3>
                    <p class="text-on-surface-variant text-sm">You are currently editing your own account. You cannot remove your own administrator privileges.</p>
                </div>
                @endif
            </div>
